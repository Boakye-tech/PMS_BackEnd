...
{
	public record RolesDto(string RoleId, string RoleName, string Department, string Unit, string CreatedBy, DateTime CreatedOn, string ApprovedBy, DateTime ApprovedOn, string Status);
